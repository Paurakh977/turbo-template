...
interface PasswordInputProps extends React.InputHTMLAttributes<HTMLInputElement> {
  label?: string;
  /**
   * Render a visible <label htmlFor> above the input (default: true).
   * Set to false when an external label already targets this input
   * (e.g. auth/page.tsx uses its own labels).
   */
  showLabel?: boolean;
}
