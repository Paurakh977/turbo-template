...
module.exports = {
  ...
  // The main suite runs the default integration specs only. The strict
  // (`.*.integration.strict.spec.ts`) and oauth (`.*oauth.integration.spec.ts`)
  // suites have dedicated configs.
  testPathIgnorePatterns: [
    '\\.strict\\.integration\\.spec\\.ts$',
